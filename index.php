...
<div id="slideshow">
	<div class="slide-container" style="background: url('assets/img/slide_new.jpg') center / cover;">
		<div class="mdl-grid" >
			...
			<div class="mdl-cell mdl-cell--12-col mdl-cell--stretch slide-content" >
				<h3>Welkom! Vraag je <strong>gratis</strong> 3-beurten kaart aan de toog. Zij geven je ook graag meer informatie over de werking van de club.</h3>
			</div>
		</div>
	</div>
	<div class="slide-container" style="background: url('assets/img/other_slide.jpg') center / cover;">
		<div class="mdl-grid" >
			<div class="mdl-cell mdl-cell--12-col mdl-cell--stretch slide-title" >
				<h1>Kijk, nog een slide!</h1>
			</div>
			<div class="mdl-cell mdl-cell--12-col mdl-cell--stretch slide-content" >
				<h3>Hier zal weer geheel andere content komen. Iets over onze evenementen misschien?</h3>
			</div>
		</div>
	</div>
</div>
